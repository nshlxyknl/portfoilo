      ...
      {items.map((item, idx) => (
        ...
        >
          <AnimatePresence>
            {hoveredIndex === idx && (
              <motion.span
                className="absolute inset-0 h-full w-full bg-[#cec9c9] dark:bg-slate-800/80 block rounded-3xl"
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-35 w-full p-4 overflow-hidden bg-[#f0eded] dark:bg-[#00030d] border border-transparent dark:border-white/20 dark:group-hover:border-slate-700 relative z-20 transition-colors duration-300",
        className
      )}
