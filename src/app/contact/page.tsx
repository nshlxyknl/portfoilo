...
const ContactPage = () => {
  ...
  return (
    ...
    <div id="contact" className="pt-50">
      <div className="h-full flex  lg:ml-0 lg:flex-row flex-col gap-20 lg:gap-50 ">
        ...
        <div className="flex flex-col ml-35 lg:ml-0 justify-center items-center gap-25">
      ...
      <div className="h-px scale-y-[0.3] lg:w-350 w-150 mt-30 mb-10 mx-auto bg-black dark:bg-blue-200"></div>
