...
import Link from "next/link"
 ...
 const AboutPage = () => {
  return (
    <div id="about" className="pt-200 lg:pt-40 ">


    <div  className="h-full flex lg:ml-0 lg:flex-row flex-col  gap-20 lg:gap-50">

        <div className=" mt-25 lg:pl-40 pl-25">
        ...
        <div className="font-serif text-3xl whitespace-pre-wrap  lg:ml-0 ml-20 ">Computer Science student with strong interest in full
          ...
          Always eager to take on new challenges and build impactful software.</div>
                ...
                <div className="h-px scale-y-[0.2] lg:w-350 w-150 mt-35 mx-auto bg-black dark:bg-blue-200"></div>
